...
TOOLS = (
    ...
    ToolSpec(
        "clipinfo",
        "sumdoc.tools.clipboard_tools",
        "Show the active clipboard backend and available representations.",
        aliases=("clipboard-info",),
        entry_point="clipinfo_main",
    ),
    ToolSpec(
        "clipbesttype",
        "sumdoc.tools.clipboard_tools",
        "Select the richest compatible clipboard representation.",
        aliases=("clipboard-best",),
        entry_point="clipbesttype_main",
    ),
    ToolSpec(
        "clip2md",
        "sumdoc.tools.clipboard_tools",
        "Convert Markdown, HTML, RTF, or plain clipboard text to Markdown.",
        aliases=("clipboard2md",),
        entry_point="clip2md_main",
    ),
    ToolSpec(
        "clip2png",
        "sumdoc.tools.clipboard_tools",
        "Save a clipboard image as PNG.",
        aliases=("clipboard2png",),
        entry_point="clip2png_main",
    ),
    ToolSpec(
        "clip2rtf",
        "sumdoc.tools.clipboard_tools",
        "Compatibility clipboard saver for RTF, HTML, Markdown, or plain text.",
        aliases=("clipboard-save",),
